...
class Trainer:
    """
    Simplified trainer interface for NeuroExapt.
    ...
    def __init__(
        ...
        self.previous_params = self.initial_params
        self.has_architecture_changes = False
    ...
    def fit(
        ...
        **kwargs
        ...
        if self.verbose:
            print(f"\n🧠 NeuroExapt Training Configuration:")
            print(f"  Model: {self.model.__class__.__name__}")
            print(f"  Epochs: {epochs} | LR: {learning_rate} | Optimizer: {optimizer_type}")
    ...
    def __repr__(self) -> str:
        ...
        return f"Trainer(model={self.model.__class__.__name__}, evolutions={evolutions})"
...
def train_with_neuroexapt(
    ...
    **kwargs
    ...
    """
    trainer = Trainer(model, device=device, **kwargs)
    history = trainer.fit(
        train_loader=train_loader,
        val_loader=val_loader,
        epochs=epochs,
